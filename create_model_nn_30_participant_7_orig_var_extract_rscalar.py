...
#model.add(Dense(40, kernel_regularizer=L2(my_L2), bias_regularizer=L2(my_L2), activity_regularizer = L2(my_L2), kernel_constraint=min_max_norm(min_value=negative_wt, #max_value=positive_wt), activation='relu'))
...
hist = model.fit(input, Y_train, batch_size=32, epochs=150, verbose=1, validation_data=(testinput, Y_test), steps_per_epoch=None, callbacks=[es, mc])
